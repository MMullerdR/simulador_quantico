...
[kernel.cu:60](../Quantum-Simulator/kernel.cu#L60), um kernel *template* em
...
`DEV_OP` ([kernel.cu:18](../Quantum-Simulator/kernel.cu#L18)) é o equivalente,
...
([common.cpp:86](../Quantum-Simulator/common.cpp#L86)), que ajusta as máscaras
...
[kernel.cu:124](../Quantum-Simulator/kernel.cu#L124). Antes de chamar o
...
`switch` ([kernel.cu:270](../Quantum-Simulator/kernel.cu#L270) e
[kernel.cu:394](../Quantum-Simulator/kernel.cu#L394)) que, para cada
...
[kernel.cu:434](../Quantum-Simulator/kernel.cu#L434) e
[kernel.cu:475](../Quantum-Simulator/kernel.cu#L475). Copiam **apenas uma
...
código em [dgm.cu:1002](../Quantum-Simulator/dgm.cu#L1002)) mandar só a fatia
